    ...
    methods: {
      ...
      openCard: function (type) {
        ...
        if (type === 'src' || type === 'dst') {
          fetchJson(API.stats + '?range=' + this.range + '&device_type=Firewall')
            .then(function (res) {
              var st = (res && res.data) || {};
          ...
          var q = '?limit=200&offset=0&device_type=Firewall';
      ...
      loadMore: function () {
        ...
        self.detailLoading = true;
        var q = '?limit=200&offset=' + self.detailLogs.length + '&device_type=Firewall';
      ...
      filterByIp: function (ip) {
        ...
        fetchJson(API.logs + '?limit=200&offset=0&device_type=Firewall&' + f + '=' + encodeURIComponent(ip))
          .then(function (res) {
            self.detailTotal = ((res && res.data) || {}).total || 0;
            self.detailLogs = ((res && res.data && res.data.data) || []);
            self.detailLoading = false;
